...
<img src='https://imbueprogram.github.io/imbue-program-docs/images/open-terminal.png'></img>
...
<img src='https://imbueprogram.github.io/imbue-program-docs/images/xcode-select-install.png'></img>
...
<img src='https://imbueprogram.github.io/imbue-program-docs/images/on-my-zsh.png'></img>


On Mac, open `Terminal > Preferences` and set the "Pro" theme as default in `Profiles` (*`Réglages`* in French).

<img src='https://imbueprogram.github.io/imbue-program-docs/images/terminal-pro.png'></img>
